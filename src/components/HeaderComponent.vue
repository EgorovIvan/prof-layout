		...
		<div class="container header__wrp">
			...
			<ul class="header__list">
				<li class="header__item">
					<button id="open-btn" class="header__button btn-icon" v-on:click="openMenu">
			...
			<nav id="menu" class="header__nav">
				<button id="close-btn" class="header__btn-close btn-close" type="button" v-on:click="closeMenu">
